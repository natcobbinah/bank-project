...
namespace BANK
{
    public partial class Customer_Information_Form : Form
    {
        ...
        {
            if ((cboDay.Text == "") && (cboYear.Text == "") && (txtBalance.Text == "") && (txtfirstname.Text == "") && (txtComboBox.Text == "") && (cboTypeAccount.Text == "") && (txtAccountNumber.Text == ""))
            ...
            else
            {
                ...
                cust.InsertBankCustomer(txtfirstname.Text, txtComboBox.Text, txtlastname.Text, txtgender.Text,
                    txtPhone.Text, day, cboMonth.Text, year, txtAccountNumber.Text, cboTypeAccount.Text,
                    cboTypeCustomer.Text, balance);
